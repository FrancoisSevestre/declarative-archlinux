...
log -c "echo $locale >> /etc/locale.gen" -m "Changing locale settings" -l "LAYER0"
log -c "locale-gen" -m "Generating locale configuration" -l "LAYER0"
log -c "echo LANG=$language > /etc/locale.conf" -m "Setting language" -l "LAYER0"
log -c "echo KEYMAP=$vconsole > /etc/vconsole.conf" -m "Setting Keyboard configuration" -l "LAYER0"
log -c "echo $hostname > /etc/hostname" -m "Setting hostname" -l "LAYER0"
